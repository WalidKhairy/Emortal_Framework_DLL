...
{
    [CustomEditor(typeof(EF_Customizer_Category))]
    public class EF_Category_Inspector : Editor 
    {
        #region Variables
        EF_Customizer_Category targetScript;
        GUISkin emortalSkin;
        #endregion
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Space(12);
            EditorGUILayout.LabelField("Customizer Category", emortalSkin.GetStyle("h1"));
