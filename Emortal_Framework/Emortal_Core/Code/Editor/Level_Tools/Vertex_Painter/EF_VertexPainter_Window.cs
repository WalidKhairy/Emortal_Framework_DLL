...
{
    public class EF_VertexPainter_Tool : EditorWindow 
    {

        #region Variables
        public EF_VTXPainterState m_CurrentState;
        ...
        public EF_MouseData m_MouseData = new EF_MouseData();
        public EF_BrushData m_BrushData = new EF_BrushData();
        ...
        {
            var win = GetWindow<EF_VertexPainter_Tool>(false, "Mesh Painter", true);
            win.m_CurrentState = EF_VTXPainterState.None;
            win.GenerateGUIStyle();

            win.m_BrushData = new EF_BrushData(1f, 0.5f, 0.5f, Color.white, EF_SculptState.NormalDir, 1f, 1, 0f);
        }
