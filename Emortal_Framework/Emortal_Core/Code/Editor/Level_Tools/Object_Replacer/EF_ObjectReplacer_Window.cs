...
{
    public class EF_ObjectReplacer_Window : EF_Base_Window 
    {
        #region Variables
        static EF_ObjectReplacer_Window m_Win;
        ...
        {
            m_Win = GetWindow<EF_ObjectReplacer_Window>(true, "Object Replacer", true);
            m_Win.Show();
        }
