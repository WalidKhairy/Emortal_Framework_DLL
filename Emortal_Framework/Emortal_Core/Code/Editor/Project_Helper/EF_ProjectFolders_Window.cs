...
{
    public class EF_ProjectFolders_Window : EF_Base_Window 
    {
        #region Variables
        static EF_ProjectFolders_Window m_Win;
        ...
        {
            m_Win = GetWindow<EF_ProjectFolders_Window>(true, "Project Folders", true);
            m_Win.Show();
        }
