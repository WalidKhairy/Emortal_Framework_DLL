...
namespace Emortal.Core
{
    public static class EF_Editor_Utils 
    {
        ...
        public static GameObject GetSelectedObject(string aWarningMessage)
        {
            ...
            if(!selectedGO)
            {
                EditorUtility.DisplayDialog("Emortal Warning", aWarningMessage, "OK");
                return null;
            }
            else
            {
        ...
        {
            GUISkin editorSkin = AssetDatabase.LoadAssetAtPath<GUISkin>("Assets/Emortal_Framework/Emortal_Core/Code/Editor/Editor_UI/Emortal_Editor_GUISkin.guiskin");
            return editorSkin;
        }

        public static GUISkin GetInspectorEditorUI()
        {
            GUISkin editorSkin = AssetDatabase.LoadAssetAtPath<GUISkin>("Assets/Emortal_Framework/Emortal_Core/Code/Editor/Editor_UI/Emortal_Inspector_GUISkin.guiskin");
            return editorSkin;
        }

        public static Texture GetEmortalLogo()
        {
            Texture logo = AssetDatabase.LoadAssetAtPath<Texture>("Assets/Emortal_Framework/Emortal_Core/Code/Editor/Editor_UI/Textures/emortal_logo_editor.png");
            return logo;
        }
